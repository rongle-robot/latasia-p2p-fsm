...
lts_conf_p2p_fsm_t lts_p2p_fsm_conf = {
    "127.0.0.1", 6379, "", "127.0.0.1", "127.0.0.1"
};


static void cb_host_match(
    void *c, lts_str_t *k, lts_str_t *v, lts_pool_t *pool
) {
    char *host;
...
static void cb_retinue_master_match(
    void *c, lts_str_t *k, lts_str_t *v, lts_pool_t *pool
) {
    char *host;
    ...
    lts_p2p_fsm_conf.retinue_master = host;

    return;
}


static void cb_retinue_vice_match(
    void *c, lts_str_t *k, lts_str_t *v, lts_pool_t *pool
) {
    char *host;
    ...
    lts_p2p_fsm_conf.retinue_vice = host;
...
lts_conf_item_t *lts_conf_p2p_fsm_items[] = {
    ...
    &(lts_conf_item_t){lts_string("retinue_master"), &cb_retinue_master_match},
    &(lts_conf_item_t){lts_string("retinue_vice"), &cb_retinue_vice_match},
    NULL,
};
